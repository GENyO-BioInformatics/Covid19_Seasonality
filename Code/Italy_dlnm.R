...
setwd("Figures")
ggsave(
    filename = "Supplementary_Figure_S16.jpeg",
    plot = dlnm_Italy_fig,
    scale = 1,
    width = 1400,
    height  = 1200,
...
Temperatures <- matrix(NA, nrow = length(list_reg$Abruzzo$Temperature), length(list_reg))
...
setwd("Figures")
ggsave(
    filename = "dlnm_meta_Italy_Temperature.jpeg",
    plot = dlnm_meta_Italy_fig,
    scale = 1,
    width = 1400,
    height  = 1200,
    units = "px",
...
setwd("Figures")
ggsave(
    filename = "Supplementary_Figure_S18.jpeg",
    plot = dlnm_Italy_fig,
    scale = 1,
    width = 1400,
    height  = 1200,
...
SHs <- matrix(NA, nrow = length(list_reg$Abruzzo$SH), length(list_reg))
...
setwd("Figures")
ggsave(
    filename = "dlnm_meta_Italy_SH.jpeg",
    plot = dlnm_meta_Italy_fig,
    scale = 1,
    width = 1400,
    height  = 1200,
